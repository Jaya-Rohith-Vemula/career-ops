...
- Named core technologies the JD centers on should appear in bullets across multiple roles where plausible for that era and seniority, not just the most recent role.
...
Output ONLY the filled-in resume as Markdown, matching the template's structure exactly with all placeholders replaced. No commentary, no code fences, no explanation before or after.
